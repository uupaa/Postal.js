// @name: Postal.js
// @description: Message delivery utility (Observer pattern implementation).
...
Postal.repository = "https://github.com/uupaa/postal.js"; // for Help.js
Postal.name = "Postal";
Postal.prototype = {
    constructor:Postal,
...
function getID(receiver) { // @arg ReceiverObject: registered receiver
                           // @ret String: postal id (receiver.__POSTAL_ID__ value) or "", "" is not registered
                           // @desc: get postal id.
                           // @help: Postal#id
